...
$VALGRIND ./$TARGET -e -m "$(head -n 1000 tests/proust_du_cote_de_chez_swann.txt )" -i tests/cat.bmp -o tests/out.bmp -f 4  2>>$LOG || fail  # tests avec beaucoup de chaine de caratctère sinon c'est trop rapide            
